...
这是 `ppt-skill` 的组件手册。template.html 已经定义好了所有样式，这里只写"这个组件长什么样、怎么用"。
...
| `.display-zh` | 超大号中文标题 | 中文衬线系统栈 700, 7.8vw |
| `.h1-zh` | 页面主标题 | 中文衬线系统栈 700, 4.6vw |
| `.h2-zh` | 副标题 | 中文衬线系统栈 600, 3.2vw |
| `.h3-zh` | 流水线步骤标题 | 中文衬线系统栈 500, 1.9vw |
| `.lead` | 引导段（比 body 大） | 中文衬线系统栈 400, 1.9vw |
| `.body-zh` | **正文/描述（非衬线）** | 中文无衬线系统栈 400, 1.22vw |
| `.body-serif` | 正文（衬线） | 中文衬线系统栈 400, 1.3vw |
...
- 模板会内嵌关键拉丁字形；中文依赖系统字体栈，不假设远程环境能拉到 Google Fonts
